          ...
          <div className="relative">
            {generating || streamingText || generatedRubric ? (
              ...
              >
                {isEditing ? (
                  <textarea
                    value={generatedRubric || streamingText}
                    onChange={(e) => setGeneratedRubric(e.target.value)}
                    className="w-full h-full min-h-[550px] p-4 bg-gray-50 dark:bg-gray-900 border border-gray-300 dark:border-gray-600 rounded-md focus:ring-2 focus:ring-purple-500 focus:border-transparent resize-none font-mono text-sm"
                    placeholder="Edit your rubric here..."
                  />
                ) : (
