...
async def submit_school_registration_request(
    ...
    try:
        ...
        # Send notification email to platform admin (background)
        send_registration_request_notification(background_tasks, registration_request)
        
        # Send confirmation email to requester (background)
        send_registration_request_confirmation(background_tasks, registration_request)
...
def send_registration_request_notification(background_tasks: BackgroundTasks, request: SchoolRegistrationRequestModel):
    """Send email notification to platform admin about new registration request (background)"""
...
def send_registration_request_confirmation(background_tasks: BackgroundTasks, request: SchoolRegistrationRequestModel):
    """Send confirmation email to the person who submitted the request (background)"""
